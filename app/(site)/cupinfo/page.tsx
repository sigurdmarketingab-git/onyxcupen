            ...
            {nivåer.map((nivå) => {
              return (
                <Link
                  ...
                  className="group cursor-pointer rounded-2xl bg-[#232830] border-t-2 border-[#F3811F] overflow-hidden hover:-translate-y-1 hover:shadow-xl hover:shadow-black/30 transition-all duration-200"
                >
                  <div className="px-8 py-10 flex flex-col gap-6 h-full">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#F3811F] group-hover:gap-3 transition-all duration-200">
