...
async function seedBoenden() {
  ...
  const data: { namn: string; adress: string; status: string; erbjudande: boolean; beskrivning: string; pris: string; ctaTyp: string; hemsidaUrl?: string; telefon?: string; imgUrl: string | null; orderRank: string }[] = [
